...
shortcode_date = '2018-04-11T11:00:00'
...
setInterval(function() {
  ...
  difference = (now-countTo);
    ...
    seconds.animate(second / 60, function() {
        seconds.setText("<span class=\"number\">" + second + "</span>" + "<span class=\"label\">SECS</span>");
    });
}, 1000);
setInterval(function() {
    now = new Date(); 
  ...
  difference = (now-countTo);
    ...
    minutes.animate(minute / 60, function() {
        minutes.setText("<span class=\"number\">" + minute + "</span>" + "<span class=\"label\">MINS</span>");
    });
}, 1000);
setInterval(function() {
    now = new Date(); 
